...
import { Book1CommentInput } from '../../../components';
import { UserContext } from '../../../context/user';


export default function Book1Post({
    profileUrl, 
    username, 
    id, 
    caption, 
    ...
    return (
        <div className="post">
            ...
            {user ? <Book1CommentInput comments={comments} id={id}/> : <div></div>}

...
import { Book3CommentInput } from '../../../components';
import { UserContext } from '../../../context/user';


export default function Book3Post({
    profileUrl, 
    username, 
    id, 
    caption, 
    ...
    return (
        <div className="post">
            ...
            {user ? <Book3CommentInput comments={comments} id={id}/> : <div></div>}
